...
const EngineeringDesign = () => {
    ...
    return (
        <section id="design">
            ...
            <img src={building} alt="" data-aos="fade-in"/>
            <div className="banner">
                <h2 data-aos="fade-in">Structural - Buildings</h2>
            ...
            <div className="banner">
                <h2 data-aos="fade-in">Structural - Civil & Marine</h2>
            ...
            <div className="banner">
                <h2 data-aos="fade-in">Remediation & Restoration</h2>
