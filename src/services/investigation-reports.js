...
const Investigation = () => {
    ...
    return (
        <section id="design">
            ...
            <img src={engineer} alt="" data-aos="fade-in"/>
            <div className="banner">
                <h2 data-aos="fade-in">Mediation and Arbitration</h2>
            ...
            <div className="banner">
                <h2 data-aos="fade-in">Feasibility Studies</h2>
            ...
            <div className="banner">
                <h2 data-aos="fade-in">Condition Assessment</h2>
