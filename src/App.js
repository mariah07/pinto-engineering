...
import im7 from "./img/bridge.jpg";
import im8 from "./img/isl.jpg";
import im9 from "./img/SJChurch2.jpg";
import im10 from "./img/texas.jpg";
import im11 from "./img/church.jpg";
import im12 from "./img/northwood.jpg";
import im13 from "./img/trillium.jpg";
import im14 from "./img/wedgewood.jpg";
import im15 from "./img/dock.jpg";
import im16 from "./img/bridge2.jpg";
import im17 from "./img/citadel.jpg";
import im18 from "./img/Highfield.jpg";
import im19 from "./img/market.jpg";
import im20 from "./img/glen.jpg";
import im21 from "./img/coving.jpg";
import im22 from "./img/comfort.jpg";
import im23 from "./img/inverary_manor.jpg";
import im24 from "./img/wickwire.jpg";
import im25 from "./img/foyer.jpg";
import im26 from "./img/windsor.jpeg";
import im27 from "./img/perkins.jpg";
import im28 from "./img/morris.jpg";
import im29 from "./img/st_george.jpg";
import im30 from "./img/uniacke.jpg";
import im31 from "./img/Thomos_duct.jpg";
import im32 from "./img/Aylesford_Church.jpg";
import im33 from "./img/inverness.jpg";
import im34 from "./img/mocton.jpg";
import im35 from "./img/St._Lawrence.jpg";
import im36 from "./img/mary-ann.jpg";
import im37 from "./img/duckworth.jpg";
import im38 from "./img/brigadoon.jpg";
import im39 from "./img/marriott.jpg";
import im40 from "./img/la-villa.jpg";
import im41 from "./img/convoy.jpg";
import im42 from "./img/waterton.jpg";
import im43 from "./img/armoury.jpg";
import im44 from "./img/woodside.jpg";
import im45 from './contact/contact-photo.jpeg';
import im46 from "./img/grand.jpg";

class App extends React.Component  {
  componentDidMount() {
    const imagesPreload = [im1, im2, im3, im4, im5, im6, im7, im8, im9, im10, im11, im12, im13, im14, im15,
