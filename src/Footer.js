        ...
        <section id="footer">
            <div className="footer">
                ...
                <div className="footer-content">
                    <h3>Connect</h3>
                    <ul className="social">
                        <li><a href="https://www.facebook.com" rel="nofollow"><i class="fab fa-facebook-square"></i></a></li>
                        <li><a href="https://www.twitter.com" rel="nofollow"><i class="fab fa-twitter-square"></i></a></li>
