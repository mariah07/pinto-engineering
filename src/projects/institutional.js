...
const Institutional = () => {
    ...
    return (
        <section id="project">
            ...
            <div className="row">
                <div className="box">
                    <a href="/projects/institutional/aylesford-church"><img loading="eager" src={alyes} alt="Aylesford Baptist Church - PINTO Engineering"/>
                    <h3>Aylesford Baptist Church, Aylesford, NS</h3></a>
                </div>
                <div className="box">
                    <a href="/projects/institutional/bedford-church"><img loading="eager" src={church} alt="Beford Baptist Church - PINTO Engineering"/>
