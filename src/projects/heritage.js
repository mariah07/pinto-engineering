...
const Heritage = () => {
    ...
    return (
        <section id="project">
            ...
            <div className="row">
                <div className="box">
                    <a href="/projects/heritage/perkins-house-museum"><img loading="eager" src={perkins} alt="Perkins House Museum - PINTO Engineering"/>
                    <h3>Perkins House Museum, Liverpool, NS</h3></a>
                </div>
                <div className="box">
                    <a href="/projects/heritage/st-john-anglican-church"><img loading="eager" src={church} alt="St John's Anglican Church Restoration - PINTO Engineering"/>
