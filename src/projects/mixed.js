...
const Mixed = () => {
    ...
    return (
        <section id="project">
            ...
            <div className="row">
                <div className="box">
                    <a href="/projects/mixed-use-development/the-trillium"><img loading="eager" src={perkins} alt="The Trillium - PINTO Engineering"/>
                    <h3>The Trillium, Halifax, NS</h3></a>
                </div>
                <div className="box">
                    <a href="/projects/mixed-use-development/saint-lawerence"><img loading="eager" src={church} alt="Saint Lawrence Place - PINTO Engineering"/>
            ...
            <div className="row">
                ...
                <div className="box">
                    <a href="/projects/mixed-use-development/brigadoon-village"><img loading="eager" src={brigadoon} alt="Brigadoon Village - PINTO Engineering"/>
                    <h3>Brigadoon Village, South Alton, NS</h3></a>
                </div>
                <div className="box">
                    <a href="/projects/mixed-use-development/marriott-residence-inn"><img loading="eager" src={marriott} alt="Marriott Residence Inn - PINTO Engineering"/>
